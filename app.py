...
def create_venue_submission():
  ...
  venue = Venue.query.filter_by(email=form.email.data).first()
  if venue:
    flash(f'Sorry, an venue is is already listed with this email: {form.email.data}')
    return render_template('pages/home.html')
    ...
    try:
      new_venue = Venue(name=fname, email=femail, phone=fphone,city=fcity,
                      state=fstate, address=faddress, website_link=fwebsite, 
